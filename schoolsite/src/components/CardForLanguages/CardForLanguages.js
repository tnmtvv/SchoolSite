        ...
        <div className="homeHeader">
            ...
            <div className="cards">
                <div data-aos="fade-up" data-aos-duration="1000">
                    <div className="card1">
                        <SimpleCard imageSize={200} fullWidth={true} title="Испанский язык" image={ch} buttonText="Узнать подробнее" simpleCardStyle={cardStyle} />
                    </div>

                </div>
                <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="1000">
                    <div className="card2">
                        <SimpleCard imageSize={200} fullWidth={true} title="Китайский язык" image={sp} buttonText="Узнать подробнее" simpleCardStyle={cardStyle} />
                    </div>
